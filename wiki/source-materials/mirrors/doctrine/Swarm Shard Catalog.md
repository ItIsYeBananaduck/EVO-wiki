...
Shard types are standardized to:
- prevent unsafe improvisation
- ensure merge compatibility
- keep parallelism deterministic
...
**Notes**
Often the first shard dispatched.

---

### 2) Intent Clarification Shard
**Purpose**
Determine what the user actually wants vs what they literally asked.
...
**Notes**
Useful when prompt is vague or overloaded.

---

### 3) Method Draft Shard
**Purpose**
Draft a candidate method that could satisfy the task.
...
**Output**
- step-by-step method outline
- required tools (declared, not executed)
- expected outputs
- risk flags
...
**Purpose**
Identify safety, privacy, or execution risks.
...
- recommendation (safe / needs review)
...
**Purpose**
Map method steps to required tools without executing them.
...
**Purpose**
Generate alternative approaches or methods.
...
**Purpose**
Detect internal conflicts or contradictions.
...
**Notes**
Often paired with Method Draft.

---

### 8) Summarization Shard
**Purpose**
Produce a concise summary of large context or artifacts.

**Input**
- long chat slice
- multiple shard outputs
...
**Notes**
Helps reduce merge complexity.

---

### 9) Acceptance Criteria Shard
**Purpose**
Define what “done” means for the task.
...
**Purpose**
Draft user-facing language (labels, prompts, explanations).
...
**Purpose**
Ensure proposed method complies with existing atomic rules and MOCs.
...
**Notes**
Extremely useful in your system.
...
UI-heavy tasks often add:
- UI Copy Shard

Architecture-heavy tasks add:
- Architecture Consistency Check

---

## Architectural Rule
Swarm parallelism increases intelligence, not authority.
